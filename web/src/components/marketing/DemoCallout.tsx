...
export function DemoCallout() {
  return (
    <Section className="bg-[var(--s-cta-bg)]">
      <Container>
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          >
            <span className="h-[11px] w-[11px] rounded-full bg-[var(--s-accent)]" style={{ boxShadow: '0 0 8px rgba(27,110,110,0.6)' }} />
            <span className="h-[11px] w-[11px] rounded-full bg-[var(--s-accent)]" style={{ boxShadow: '0 0 8px rgba(27,110,110,0.6)' }} />
          </div>

          <div className="brand-eyebrow centered mb-5 justify-center">Meet Denku</div>
          <h2 className="font-display text-[clamp(32px,3.8vw,50px)] font-normal leading-[1.08] tracking-[-1.2px] text-[var(--s-cta-fg)]">
            Don&apos;t just read about it.
            <br />
            Talk to it <em className="font-medium italic text-[var(--s-accent-deep)]">right now</em>.
          </h2>
          <p className="mx-auto mt-5 max-w-lg text-[18px] leading-relaxed text-[var(--s-cta-fg)]">

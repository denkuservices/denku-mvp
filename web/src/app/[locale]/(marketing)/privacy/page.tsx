    ...
    <div className="py-16 md:py-20">
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-display text-[clamp(36px,4.5vw,56px)] font-normal tracking-[-1.5px] text-[var(--s-ink)]">{t('privacyTitle')}</h1>
          <p className="mt-4 text-[17px] text-[var(--s-ink-soft)]">{t('privacyIntro')}</p>

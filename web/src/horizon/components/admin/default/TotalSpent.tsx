...
const TotalSpent = ({
  ...
  const chartData = [
    {
      name: "Total Calls",
      data: totalCallsSeries.map((s) => s.value),
      color: "#4318FF",
    },
    {
      name: "Handled Calls",
      data: handledCallsSeries.map((s) => s.value),
      color: "#6AD2FF",
    },
  ];
  ...
  const chartOptions = {
    ...
    xaxis: {
      ...
      categories: totalCallsSeries.map((s) => s.monthLabel),
    },
  };
      ...
      <div className="flex h-full w-full flex-row justify-between sm:flex-wrap lg:flex-nowrap 2xl:overflow-hidden">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col items-start">
            <p className="mt-2 text-sm text-gray-600">Total Calls</p>
